            ...
            <div class="container">
                <div class="float--left float--xs-none text-xs-center">
                    <ul class="header--topbar-info nav">
                        ...
                        <li><i class="fa fm fa-calendar"></i>আজ (<p style="display:inline-block">{{
                                EnToBnWeakName(date("l")) }} <span>{{ EntoBnDateforH(date("d-F-Y"))}}</span>ইং </p>)
                        </li>
                        <li><i class="fa fm fa-calendar"></i>আজ (<p style="display:inline-block" class="bongabdo"></p>)
                        </li>
                    </ul>
                </div>
                <div class="float--right float--xs-none text-xs-center">
                    ...
                    <ul class="header--topbar-lang nav" style="border:none">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa-solid fa-user"></i>
                                Profile<i class="fa flm fa-angle-down"></i></a>
                    ...
                    <ul class="header--topbar-lang nav">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                                    class="fa fm fa-language"></i>বাংলা<i class="fa flm fa-angle-down"></i></a>
                            <ul class="dropdown-menu">
                    ...
                    <ul class="header--topbar-social nav hidden-sm hidden-xxs">
                        ...
                        <li>
                            <a href="{{$social_links_data->printerest}}"><i
        ...
        <div class="header--mainbar">
            <div class="container">
                <div class="header--logo float--left float--sm-none text-sm-center">
                    <h1 class="h1">
                        <a href="/" class="btn-link"> <img src="{{asset(''.$website_logo)}}" alt="" /> <span
                                class="hidden">Amin IT news Logo</span> </a>
                    </h1>
                </div>
            ...
            <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
                        ...
                        <span class="sr-only">টগল নেভিগেশন </span> <span class="icon-bar"></span> <span
                            class="icon-bar"></span> <span class="icon-bar"></span>
                    </button>
                    <button type="button" class="navbar-toggle collapsed" id="desk_bars" data-toggle="collapse"
                        data-target="#headerNav2" aria-controls="headerNav2" aria-expanded="false">
                        <span class="sr-only">টগল নেভিগেশন </span> <span class="icon-bar"></span> <span
                            class="icon-bar"></span> <span class="icon-bar"></span>
                    </button>
                </div>
                ...
                <div id="headerNav2" class="navbar-collapse collapse float--left">
                    ...
                    <ul class="header--menu-links nav navbar-nav" data-trigger="hoverIntent">
                        ...
                        <li><a
                                href="/category/{{str_replace(' ', '-', $categoryMenu->Name)}}">{{$categoryMenu->Name}}</a>
                        </li>
                        @endforeach
                ...
                <div class="header--search-form float--right">
                    <input type="search" id="search" name="search" placeholder="অনুসন্ধান করুন..."
                        class="header--search-control form-control" required />
                    <button type="submit" onclick="onSearch()" class="header--search-btn btn"><i
