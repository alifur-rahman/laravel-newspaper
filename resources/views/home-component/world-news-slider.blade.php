...
$dataArray = post_table_model::where('lang','=','bn')->where('catagories','=','বিশ্ব সংবাদ')->where('status','=','Publish')->where('public_date','=',$todayDate)->orderBy('id', 'desc')->get();
...
<div class="col-md-6 ptop--30">
    ...
    <div class="post--items post--items-2 items-carousel owl-carousel owl-theme al-item-mb">
        ...
        @if ($array_count<$maxItem) <ul class="nav row gutter--15">
            ...
            @else
            @for ($i = 1; $i < $from; $i++) <ul class="nav row gutter--15">
                @foreach ($dataArray->slice($st, $en) as $item )
                @if ($coun == $condi)
                <li class="col-xs-12">
                    <div class="post--item post--layout-1">
