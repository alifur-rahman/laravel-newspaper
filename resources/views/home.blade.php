    ...
    <div class="container">
                    ...
                    <div class="col-md-6">
                        <div class="post--item post--layout-1 post--title-larger">
                            <div class="post--img first-image">
                                <a href="/single/{{base64_encode($PostLastIndexData->id)}}/{{str_replace(' ', '-', $PostLastIndexData->post_title)}}"
                                    class="thumb">
                                    <img src="{{asset(''.$PostLastIndexData->post_thumbnail)}}" alt="" />
                                </a>
                                <a href="/category/{{str_replace(' ', '-', $PostLastIndexData->catagories)}}"
                                    class="cat">{{$PostLastIndexData->catagories}}</a>
                                ...
                                <ul class="banner_icon" dir="rtl">
                                    ...
                                    <li><a href="/filter/featured_news" class=""><i class="fa-solid fa-star"></i></a>
                                    </li>
                                    @endif
                                    @if ($PostLastIndexData->most_popular == 1)
                                    <li><a href="/filter/most_popular" class=""><i class="fa-solid fa-heart"></i></a>
                                    </li>
                                    @endif
                                ...
                                <div class="post--info">
                                    <ul class="nav meta">
                                        ...
                                        <li><a href="#">{{EntoBnDate(date( "d-M-Y",
                                                strtotime($PostLastIndexData->public_date) )) }} </a></li>
                                    </ul>
                                    <div class="title">
                                        <h2 class="h4">
                                            <a href="/single/{{base64_encode($PostLastIndexData->id)}}/{{str_replace(' ', '-', $PostLastIndexData->post_title)}}"
                                                class="btn-link">{{$PostLastIndexData->post_title}}</a>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="row gutter--15">
                            ...
                            <div class="col-xs-6 col-xss-12">
                                <div class="post--item post--layout-1 post--title-large">
                                    <div class="post--img second-post-img">
                                        <a href="/single/{{base64_encode($news2->id)}}/{{str_replace(' ', '-', $news2->post_title)}}"
                                            class="thumb"><img src="{{asset(''.$news2->post_thumbnail)}}" alt="" /></a>
                                        <a href="/category/{{str_replace(' ', '-', $news2->catagories)}}"
                                            class="cat">{{$news2->catagories}}</a>
                                        <ul class="banner_icon" dir="rtl">
                                            {{-- @if ($news2->new_trends == 1)
                                            <li><a href="/filter/new_trends" class=""><i
                                                        class="fa-solid fa-bolt"></i></a></li>
                                            @endif
                                            @if ($news2->featured_news == 1)
                                            <li><a href="/filter/featured_news" class=""><i
                                                        class="fa-solid fa-star"></i></a></li>
                                            @endif
                                            @if ($news2->most_popular == 1)
                                            <li><a href="/filter/most_popular" class=""><i
                                                        class="fa-solid fa-heart"></i></a></li>
                                            @endif
                                            @if ($news2->hot_news == 1)
                                            <li><a href="/filter/hot_news" class=""><i class="fa-solid fa-fire"></i></a>
                                            </li>
                                            @endif --}}
                                        </ul>
                                        <div class="post--info">
                                            <ul class="nav meta">
                                                <li><a href="#">নিজস্ব প্রতিবেদক</a></li>
                                                <li><a href="#">{{EntoBnDate(date( "d-M-Y",
                                                        strtotime($news2->public_date) )) }}</a></li>
                                            </ul>
                                            <div class="title">
                                                <h2 class="h4"><a
                                                        href="/single/{{base64_encode($news2->id)}}/{{str_replace(' ', '-', $news2->post_title)}}"
                                                        class="btn-link">{{$news2->post_title}}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-6 hidden-xss">
                                <div class="post--item post--layout-1 post--title-large">
                                    <div class="post--img second-post-img">
                                        <a href="/single/{{base64_encode($news3->id)}}/{{str_replace(' ', '-', $news3->post_title)}}"
                                            class="thumb"><img src="{{asset(''.$news3->post_thumbnail)}}" alt="" /></a>
                                        <a href="/category/{{str_replace(' ', '-', $news3->catagories)}}"
                                            class="cat">{{$news3->catagories}}</a>
                                        <ul class="banner_icon" dir="rtl">
                                        ...
                                        <div class="post--info">
                                            <ul class="nav meta">
                                                <li><a href="#">নিজস্ব প্রতিবেদক</a></li>
                                                <li><a href="#"> {{EntoBnDate(date( "d-M-Y",
                                                        strtotime($news3->public_date) )) }}</a></li>
                                            </ul>
                                            <div class="title">
                                                <h2 class="h4"><a
                                                        href="/single/{{base64_encode($news3->id)}}/{{str_replace(' ', '-', $news3->post_title)}}"
                                                        class="btn-link">{{$news3->post_title}}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 hidden-sm hidden-xs">
                                <div class="post--item post--layout-1 post--title-larger">
                                    <div class="post--img second-post-img">
                                        <a href="/single/{{base64_encode($news4->id)}}/{{str_replace(' ', '-', $news4->post_title)}}"
                                            class="thumb"><img src="{{asset(''.$news4->post_thumbnail)}}" alt="" /></a>
                                        <a href="/category/{{str_replace(' ', '-', $news4->catagories)}}"
                                            class="cat">{{$news4->catagories}}</a>
                                        {{-- <ul class="banner_icon" dir="rtl">
                                        ...
                                        <div class="post--info">
                                            <ul class="nav meta">
                                                <li><a href="#">নিজস্ব প্রতিবেদক</a></li>
                                                <li><a href="#">{{ EntoBnDate(date( "d-M-Y",
                                                        strtotime($news4->public_date) ))}}</a></li>
                                            </ul>
                                            <div class="title">
                                                <h2 class="h4"><a
                                                        href="/single/{{base64_encode($news4->id)}}/{{str_replace(' ', '-', $news4->post_title)}}"
                                                        class="btn-link">{{$news4->post_title}}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row gutter--15 ">
                    ...
                    <div class="Al_ads_area col-md-12 ads-775x200">
                        ...
                        <div class=" adds-area al-ads-item text-left">
                            <a target="_blank" href="{{$item->URL}}"><img src=" {{asset(''.$item->image)}} "
                                    alt="Ads Position 1"></a>
                        </div>
                    ...
                    <div class="Al_ads_area col-md-6 ads-775x200">
                        ...
                        <div class="adds-area al-ads-item text-right">
                            <a target="_blank" href="{{$item->URL}}"><img src=" {{asset(''.$item->image)}}  "
                                    alt="Ads Position 2"></a>
                        </div>
                        @elseif($item->ads_type == "google")
                        <div
                            class="header--ad float--right float--sm-none hidden-xs al-ads-item header-ads-al text-right">
                            <p>Can't passible show google ads in demo</p>
                        </div>
                        @elseif($item->ads_type == "script")
                        <div
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 Al_ads_area ads-728x80">
                            ...
                            <div class="ad--space al-ads-item">
                                <a target="_blank" href="{{$item->URL}}"> <img style="height: 100px; width:100%"
                                        src=" {{asset(''.$item->image)}}" alt="Ads Position 3" class="center-block" />
                                </a>
                            </div>
                            @elseif($item->ads_type == "google")
                        ...
                        {{-- <div class="col-md-12 ptop--30 pbottom--30">
                            <div class="post--items-title" data-ajax="tab">
                                ...
                                <div class="nav">
                                    ...
                                    <a href="#" style="opacity:0;" class="next btn-link"> <i
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1-boxed.html" class="thumb"><img
                                                        src="{{asset('img/home-img/finance-01.jpg')}} " alt="" /></a> <a
                                                    href="#" class="cat">ব্যবসা</a>
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4">
                                                            <a href="news-single-v1-boxed.html" class="btn-link">
                                                                ভেরো ইওস এট অ্যাকুসামাস এট আইস্টো অডিও ডিগ্নিসিমোস
                                                                ডুসিমাস কুই ব্লান্ডটিটিস প্রেসেনশিয়াম ভলুপট্যাটম
                                                                ডিলেনিটি এটকে দুর্নীতিগ্রস্ত কোস ডলোরেস এট কোয়াস।
                                                            </a>
                                                        </h3>
                                                    </div>
                                                </div>
                                        ...
                                        <ul class="nav row">
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img
                                                                src=" assets/img/home-img/finance-02.jpg" alt="" /></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a href="news-single-v1-boxed.html"
                                                                        class="btn-link">এটি একটি দীর্ঘ প্রতিষ্ঠিত সত্য
                                                                        যে একটি পাঠক হবে</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img
                                                                src="assets/img/home-img/finance-03.jpg" alt="" /></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img
                                                                src="assets/img/home-img/finance-04.jpg" alt="" /></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">জগতের স্রষ্টা</a></li>
                                                                <li><a href="#">আজ দুপুর 03:02 pm</a></li>
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img
                                                                src="assets/img/home-img/finance-05.jpg" alt="" /></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">জগতের স্রষ্টা</a></li>
                                                                <li><a href="#">আজ দুপুর 03:02 pm</a></li>
                                ...
                                <ul class="nav row">
                                    <li class="col-md-6">
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1-boxed.html" class="thumb"><img
                                                        src="assets/img/home-img/finance-01.jpg" alt="" /></a> <a
        ...
        {{-- <div class="main--content pd--30-0">
            <div class="post--items-title" data-ajax="tab">
                ...
                <div class="nav">
                    <!-- <a href="#" class="prev btn-link" data-ajax-action="load_prev_world_news_posts"> <i class="fa fa-long-arrow-left"></i> </a>  -->
                    <span class="divider">/</span>
                    <a href="#" style="opacity:0; visibility: hidden;" class="next btn-link"> <i
                            class="fa fa-long-arrow-right"></i> </a>
                </div>
            </div>
                ...
                <ul class="nav row">
                    <li class="col-md-8">
                        <div class="post--item post--layout-1 post--type-video post--title-large">
                            <div class="post--img">
                                <a href="news-single-v1-boxed.html" class="thumb"><img
                                        src="assets/img/home-img/audio-video-01.jpg" alt="" /></a> <a href="#"
                                    class="cat">তরঙ্গ</a> <a href="#" class="icon"><i class="fa fa-eye"></i></a>
                                <div class="post--info">
                                    <ul class="nav meta">
                                    ...
                                    <div class="title">
                                        <h2 class="h4">
                                            <a href="news-single-v1-boxed.html" class="btn-link">
                                                1500 এর দশক থেকে ব্যবহৃত Lorem Ipsum-এর স্ট্যান্ডার্ড অংশ আগ্রহীদের জন্য
                                                নীচে পুনরুত্পাদন করা হয়েছে। বিভাগ 1.10.32 এবং 1.10.33 "ডি ফিনিবাস
                                                বোনোরাম" থেকে
                                            </a>
                                        </h2>
                                    </div>
                        ...
                        <ul class="nav video-items">
                            <li>
                                <div class="post--item post--type-audio post--layout-3">
                                    <div class="post--img">
                                        <a href="news-single-v1-boxed.html" class="thumb"><img
                                                src="assets/img/home-img/audio-video-02.jpg" alt="" /></a>
                                        <div class="post--info">
                                            <ul class="nav meta">
                                            ...
                                            <div class="title">
                                                <h3 class="h4"><a href="news-single-v1-boxed.html"
                                                        class="btn-link">দীর্ঘদিন ধরে প্রতিষ্ঠিত সত্য যে একজন পাঠক
                                                        পাঠযোগ্য দ্বারা বিভ্রান্ত হবেন</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="mt-2">
                                <div class="post--item post--type-video post--layout-3">
                                    <div class="post--img">
                                        <a href="news-single-v1-boxed.html" class="thumb"><img
                                                src="assets/img/home-img/audio-video-04.jpg" alt="" /></a>
                                        <div class="post--info">
                                            <ul class="nav meta">
                                                <li><a href="#">ম্যাক্লান জন</a></li>
                                                <li><a href="#">16 এপ্রিল 2017</a></li>
                            ...
                            <li class="mt-2">
                                <div class="post--item post--type-audio post--layout-3">
                                    <div class="post--img">
                                        <a href="news-single-v1-boxed.html" class="thumb"><img
                                                src="assets/img/home-img/audio-video-05.jpg" alt="" /></a>
                                        <div class="post--info">
                                            <ul class="nav meta">
                                                <li><a href="#">ম্যাক্লান জন</a></li>
                                                <li><a href="#">16 এপ্রিল 2017</a></li>
                    ...
                    <li class="col-md-8">
                        <div class="post--item post--layout-1 post--type-video post--title-large">
                            <div class="post--img">
                                <a href="news-single-v1-boxed.html" class="thumb"><img
                                        src="assets/img/home-img/audio-video-01.jpg" alt="" /></a> <a href="#"
                                    class="cat">Wave</a> <a href="#" class="icon"><i class="fa fa-eye"></i></a>
                                <div class="post--info">
                                    <ul class="nav meta">
                                        <li><a href="#">সুকুবাস</a></li>
                                        <li><a href="#">আজ 03:52 pm</a></li>
                        ...
                        <ul class="nav">
                            ...
                            <li>
                                <div class="post--item post--type-video post--layout-3">
                                    <div class="post--img">
                                        <a href="news-single-v1-boxed.html" class="thumb"><img
                                                src="assets/img/home-img/audio-video-03.jpg" alt="" /></a>
                                        <div class="post--info">
                                            <ul class="nav meta">
                                                <li><a href="#">ম্যাক্লান জন</a></li>
                                                <li><a href="#">16 এপ্রিল 2017</a></li>
        ...
        <div class="Al_ads_area ptop--30 ads-728x80">
            ...
            <div class="ad--space pd--30-0 al-ads-item">
                <a target="_blank" href="{{$item->URL}}"><img src="{{asset(''.$item->image)}} " class="center-block"
                        style="width: 80%; height:80px" alt="Ads Position 7"></a>
            </div>
            @elseif($item->ads_type == "google")
            <div class="header--ad float--right float--sm-none hidden-xs al-ads-item header-ads-al">
                <p>Can't passible show google ads in demo</p>
                            ...
                            <div class="row">
                                ...
                                <div class="Al_ads_area col-sm-6 ads-165x125">
                                    ...
                                    <div class="  al-ads-item">
                                        <a target="_blank" href="{{$item->URL}}"><img src="{{asset(''.$item->image)}} "
                                                alt="Ads Position 8"></a>
                                    </div>
                                    @elseif($item->ads_type == "google")
                                    <div
                                        class="header--ad float--right float--sm-none hidden-xs al-ads-item header-ads-al">
                                        <p>Can't passible show google ads in demo</p>
                                    </div>
                                    @elseif($item->ads_type == "script")
                                    <div
