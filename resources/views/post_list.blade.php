                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12 col-xs-4 col-xxs-12">
                                            <div class="post--img">
                                                <a href="/single/{{base64_encode($item->id)}}/{{str_replace(' ', '-', $item->post_title)}}"
                                                    class="thumb"><img src="{{asset(''.$item->post_thumbnail)}} " alt=""
                                                        data-rjs="2" /></a>
                                                <a href="/category/{{str_replace(' ', '-', $item->catagories)}}"
                                        ...
                                        <div class="col-md-8 col-sm-12 col-xs-8 col-xxs-12">
                                            <div class="post--info">
                                                <ul class="nav meta">
                                                    <li><a
                                                            href="/single/{{base64_encode($item->id)}}/{{str_replace(' ', '-', $item->post_title)}}">নিজস্ব
                                                            প্রতিবেদক </a></li>
                                                    <li><a
                                                            href="/single/{{base64_encode($item->id)}}/{{str_replace(' ', '-', $item->post_title)}}">{{EntoBnDate(date(
                                                            "d-M-Y", strtotime($item->public_date) )) }}</a></li>
                                                </ul>
                                                <div class="title">
                                                    <h3 class="h4">
                                                        <a href="/single/{{base64_encode($item->id)}}/{{str_replace(' ', '-', $item->post_title)}}"
                                                            class="btn-link">{{$item->post_title}}</a>
                                                    </h3>
                                                </div>
                                            </div>
                                            ...
                                            <div class="post--action"><a
                                                    href="/single/{{base64_encode($item->id)}}/{{str_replace(' ', '-', $item->post_title)}}">পড়া
                                                    চালিয়ে যান...</a></div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="sticky-content-inner"
                    ...
                    <div class="resize-sensor"
                        ...
                        <div class="resize-sensor-expand"
                            ...
                            <div
                                style="position: absolute; left: 0px; top: 0px; transition: all 0s ease 0s; width: 400px; height: 3220px;">
                            </div>
                        </div>
