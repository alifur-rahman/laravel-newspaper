            ...
            <div class="main--content col-md-8" data-sticky-content="true">
                <div class="sticky-content-inner">
                    <div class="post--item post--single post--title-largest pd--30-0">
                        <div class="post--img">
                            <a href="#" class="thumb"><img src="{{asset(''.$post_thumbnail)}} " alt="" /></a> <a
                                href="#" class="icon"><i class="fa-solid fa-star"></i></a>
                            {{-- <div class="post--map">
                ...
                <div class="sticky-content-inner">
                    {{-- <div class="widget">
                        ...
                        <div class="subscribe--widget">
                            <div class="content">
                                <p>সর্বশেষ খবর, জনপ্রিয় খবর এবং একচেটিয়া আপডেট পেতে আমাদের নিউজলেটারে সদস্যতা নিন।</p>
                            </div>
                            <form action="#" method="post" name="mc-embedded-subscribe-form" target="_blank"
                                data-form="mailchimpAjax">
                                <div class="input-group">
                                    <input type="email" name="EMAIL" placeholder="ই-মেইল ঠিকানা" class="form-control"
